...
pub struct ApplicationCommandSubcommandOptionResponse {
    ...
    pub options: Option<Vec<models::ApplicationCommandSubcommandOptionResponseOptionsInner>>,
}

impl ApplicationCommandSubcommandOptionResponse {
    pub fn new(r#type: i32, name: String, description: String) -> ApplicationCommandSubcommandOptionResponse {
