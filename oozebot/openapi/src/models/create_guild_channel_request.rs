...
pub struct CreateGuildChannelRequest {
    ...
    pub available_tags: Option<Option<Vec<models::CreateOrUpdateThreadTagRequest>>>,
}

impl CreateGuildChannelRequest {
    pub fn new(name: String) -> CreateGuildChannelRequest {
