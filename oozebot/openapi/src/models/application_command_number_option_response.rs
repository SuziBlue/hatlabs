...
pub struct ApplicationCommandNumberOptionResponse {
    ...
    pub choices: Option<Vec<models::ApplicationCommandOptionNumberChoiceResponse>>,
...
impl ApplicationCommandNumberOptionResponse {
    pub fn new(r#type: i32, name: String, description: String) -> ApplicationCommandNumberOptionResponse {
