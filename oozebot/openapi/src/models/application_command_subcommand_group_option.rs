...
pub struct ApplicationCommandSubcommandGroupOption {
    ...
    pub options: Option<Option<Vec<models::ApplicationCommandSubcommandOption>>>,
}

impl ApplicationCommandSubcommandGroupOption {
    pub fn new(r#type: i32, name: String, description: String) -> ApplicationCommandSubcommandGroupOption {
