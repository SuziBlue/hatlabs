...
pub struct UserSelectComponentResponse {
    ...
    pub default_values: Option<Vec<models::UserSelectDefaultValueResponse>>,
}

impl UserSelectComponentResponse {
    pub fn new(r#type: i32, id: i32, custom_id: String) -> UserSelectComponentResponse {
