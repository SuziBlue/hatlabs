...
pub struct StringSelectComponentResponse {
    ...
    pub options: Vec<models::StringSelectOptionResponse>,
}

impl StringSelectComponentResponse {
    pub fn new(r#type: i32, id: i32, custom_id: String, options: Vec<models::StringSelectOptionResponse>) -> StringSelectComponentResponse {
