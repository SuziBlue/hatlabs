...
pub struct ApplicationCommandSubcommandOption {
    ...
    pub options: Option<Option<Vec<models::ApplicationCommandSubcommandOptionOptionsInner>>>,
}

impl ApplicationCommandSubcommandOption {
    pub fn new(r#type: i32, name: String, description: String) -> ApplicationCommandSubcommandOption {
