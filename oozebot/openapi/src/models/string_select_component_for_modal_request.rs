...
impl StringSelectComponentForModalRequest {
    pub fn new(r#type: i32, custom_id: String, options: Vec<models::StringSelectOptionForRequest>) -> StringSelectComponentForModalRequest {
