...
pub struct MentionableSelectComponentResponse {
    ...
    pub default_values: Option<Vec<models::MentionableSelectComponentResponseDefaultValuesInner>>,
}

impl MentionableSelectComponentResponse {
    pub fn new(r#type: i32, id: i32, custom_id: String) -> MentionableSelectComponentResponse {
