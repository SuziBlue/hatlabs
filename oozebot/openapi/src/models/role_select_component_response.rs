...
pub struct RoleSelectComponentResponse {
    ...
    pub default_values: Option<Vec<models::RoleSelectDefaultValueResponse>>,
}

impl RoleSelectComponentResponse {
    pub fn new(r#type: i32, id: i32, custom_id: String) -> RoleSelectComponentResponse {
