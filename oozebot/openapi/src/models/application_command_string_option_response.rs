...
pub struct ApplicationCommandStringOptionResponse {
    ...
    pub choices: Option<Vec<models::ApplicationCommandOptionStringChoiceResponse>>,
...
impl ApplicationCommandStringOptionResponse {
    pub fn new(r#type: i32, name: String, description: String) -> ApplicationCommandStringOptionResponse {
